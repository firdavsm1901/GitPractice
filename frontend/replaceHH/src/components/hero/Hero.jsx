        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            <h1 className="title-font sm:text-5xl text-4xl mb-4 font-bold text-gray-900">
              Find world’s <br className="hidden lg:inline-block" />
              best{" "}
              <span className="text-green-700 inline-block">
                <Typewriter
                  options={{
                    strings: ["remote job", "online job", "freelance job"],
                    autoStart: true,
                    loop: true,
                    delay: 75,
                    deleteSpeed: 40,
            ...
            <div className="flex gap-10">
              <div className="text-center">
                <p className="text-3xl font-bold text-green-700">60K+</p>
                <p className="text-gray-700">Jobs submitted</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold text-green-700">30K+</p>
                <p className="text-gray-700">Monthly Users</p>
              </div>
            </div>
          </div>
